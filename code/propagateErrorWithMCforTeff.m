function [teffAnnual] = propagateErrorWithMCforTeff(arrayFlux,isMeansOfMeans)
...
NUM_LOCS = size(arrayFlux,3);

% Define output arrays
if isMeansOfMeans
    teffMonthly        = NaN(12,NUM_LOCS,5); % 3rd dim: 1=median, 2=upp CI, 3=low CI, 4=max, 5=min
    teffMonthly_mcvals = NaN(12,NUM_LOCS,NUM_MONTE_CARLO_SAMPLES);
    teffAnnual         = NaN(NUM_LOCS,5);
else
    teffAnnual         = NaN(NUM_LOCS,5); % 2nd dim: 1=median, 2=upp CI, 3=low CI, 4=max, 5=min
    teffAnnual_mcvals  = NaN(NUM_LOCS,NUM_MONTE_CARLO_SAMPLES);
end
